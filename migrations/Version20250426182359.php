 ...
 */
final class Version20250426182359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE artist ADD image VARCHAR(255) DEFAULT NULL, CHANGE bio bio TEXT NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE artist DROP image, CHANGE bio bio LONGTEXT NOT NULL
        SQL);
    }
}
